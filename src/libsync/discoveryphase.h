...
signals:
    void fatalError(const QString &errorString, OCC::ErrorCategory errorCategory);
    ...
    void addErrorToGui(SyncFileItem::Status status, const QString &errorMessage, const QString &subject, OCC::ErrorCategory category);
};
