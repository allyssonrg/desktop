...
signals:
    ...
    void syncError(const QString &message, OCC::ErrorCategory category);

    void addErrorToGui(OCC::SyncFileItem::Status status, const QString &errorMessage, const QString &subject, OCC::ErrorCategory category);
...
private slots:
    ...
    void slotItemCompleted(const OCC::SyncFileItemPtr &item, OCC::ErrorCategory category);
    ...
    void slotCleanPollsJobAborted(const QString &error, OCC::ErrorCategory category);
