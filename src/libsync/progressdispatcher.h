...
signals:
     ...
     */
    void itemCompleted(const QString &folder, const OCC::SyncFileItemPtr &item, OCC::ErrorCategory category);
     ...
     */
    void addErrorToGui(const QString &folder, OCC::SyncFileItem::Status status, const QString &errorMessage, const QString &subject, OCC::ErrorCategory category);
